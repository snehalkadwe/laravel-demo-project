        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('documents.store') }}" enctype="multipart/form-data" id="dropdocument-form"
                        method="POST">
                        @csrf
                        <div class="mb-2"> <span>Attachments</span>
                            <div
                                ...
                                <input type="file" class="h-full w-full opacity-0" name="documentFile" >
                            </div>
                            <div class="flex justify-between items-center text-gray-400">
                                <span>Accepted file type: PDF, DOC, DOCX up to 10MB</span>
                            </div>
                        </div>
